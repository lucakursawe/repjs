...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-10 px-6 bg-white">
      <h1 className="text-4xl sm:text-6xl font-extrabold mb-6 text-center sm:text-left text-primary-orange mx-auto max-w-6xl">
        Autoregulate Your Training with <span className="font-bold text-primary-orange">REP.js</span>
      </h1>
      <div className="w-full max-w-6xl mx-auto pb-10">
        <div className="flex flex-col lg:flex-row items-start lg:items-start justify-between space-y-6 lg:space-y-0">
          <div className="lg:w-2/3 space-y-6 mt-6"> {/* Added mt-2 to lower the text slightly */}
