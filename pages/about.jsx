  ...
  return (
    <div className="container mx-auto p-4"> {/* Container div with centered alignment and padding */}
      <div className="w-full max-w-6xl mx-auto"> {/* Wrapper div for consistent width and centering */}
        <h1 className="text-3xl font-bold mb-4 text-primary-orange">About</h1> {/* Header with classes for font size, bold, and margin bottom */}
        <div className="flex flex-wrap md:flex-nowrap items-center"> {/* Flexbox div for arranging inner elements */}
          <div className="w-full md:w-1/3 p-4 flex flex-col justify-center items-center"> {/* Div for the first section with full width on small screens and one-third width on medium and larger screens */}
            <div className="bg-white shadow-md rounded-lg p-4 flex flex-col items-center"> {/* White background, shadow, rounded corners, and padding */}
              <img src="/luca.jpg" alt="Luca" className="rounded-full w-32 h-32 mb-4"/> {/* Image of Luca with rounded corners, fixed width and height, and margin bottom */}
              <h2 className="text-xl font-bold text-center mb-2">Luca</h2> {/* Subheading with classes for font size, bold, centered text, and margin bottom */}
              <p className="text-center text-black">Computer Science Student</p> {/* Description text with centered black text */}
              <p className="text-center text-black">Web Design & Frontend Development</p> {/* Additional description */}
          ...
          <div className="w-full md:w-2/3 p-4 flex flex-col justify-center"> {/* Div for the second section with full width on small screens and two-thirds width on medium and larger screens */}
            <div className="bg-white shadow-md rounded-lg p-4"> {/* White background, shadow, rounded corners, and padding */}
              <p className="mb-4">
              ...
              </p> {/* Greeting text and introduction */}
              <p className="mb-4">
              ...
              </p> {/* Explanation of the app's foundation */}
              <p className="mb-4">
              ...
              </p> {/* Note for beginners in weightlifting */}
            </div>
          </div>
        </div>
      </div>
