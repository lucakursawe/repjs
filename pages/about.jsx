      ...
      <div className="flex flex-wrap md:flex-nowrap items-center">
        <div className="w-full md:w-1/3 p-4 flex flex-col justify-center items-center">
          <div className="bg-white shadow-md rounded-lg p-4 flex flex-col items-center">
            <img src="/luca.jpg" alt="Luca" className="rounded-full w-32 h-32 mb-4"/>
            <h2 className="text-xl font-bold text-center mb-2">Luca</h2>
            <p className="text-center text-black">Computer Science Student</p>
            <p className="text-center text-black">Web Design & Frontend Development</p>
            <div className="mt-4">
              <h3 className="text-lg font-bold mb-2 text-primary-orange">Socials</h3>
              <div className="flex space-x-4">
                <a href="https://linkedin.com/in/lucakursawe" target="_blank" rel="noopener noreferrer">
                  <FaLinkedin className="h-6 w-6 text-black hover:text-primary-orange"/>
                </a>
                <a href="https://github.com/lucakursawe" target="_blank" rel="noopener noreferrer">
                  <FaGithub className="h-6 w-6 text-black hover:text-primary-orange"/>
                </a>
                <a href="https://instagram.com/lucakursawe" target="_blank" rel="noopener noreferrer">
                  <FaInstagram className="h-6 w-6 text-black hover:text-primary-orange"/>
                </a>
              </div>
            </div>
          </div>
